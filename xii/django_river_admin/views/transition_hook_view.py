...
from xii.django_river.models import OnTransitHook

from xii.django_river_admin.views import post, delete
from xii.django_river_admin.views.serializers import CreateTransitionHookDto


@post(r'^transition-hook/create/$', permission='xii_django_river.add_ontransithook')
...
@delete(r'^transition-hook/delete/(?P<pk>\w+)/$', permission='xii_django_river.delete_ontransithook')
