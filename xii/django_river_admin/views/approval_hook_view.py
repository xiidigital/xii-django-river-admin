...
from xii.django_river.models import OnApprovedHook

from xii.django_river_admin.views import post, delete
from xii.django_river_admin.views.serializers import CreateApprovalHookDto


@post(r'^approval-hook/create/$', permission='xii_django_river.add_onapprovedhook')
...
@delete(r'^approval-hook/delete/(?P<pk>\w+)/$', permission='xii_django_river.delete_onapprovedhook')
