...
from xii.django_river_admin.views.serializers import StateDto, CreateStateDto
...
@post(r'^state/create/$', permission='xii_django_river.add_state')
...
@delete(r'^state/delete/(?P<pk>\w+)/$', permission='xii_django_river.delete_state')
