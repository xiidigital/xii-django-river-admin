...
class TransitionMetaViewTest(TestCase):
    ...
    def test__shouldNotCreateTransitionMetaWhenWorkflowIsMissing(self):
        ...
        user.user_permissions.add(Permission.objects.get(codename="add_transitionmeta"))
        self.client.force_login(user)
    ...
    def test__shouldRejectCreateWithoutPermission(self):
        ...
        assert_that(TransitionMeta.objects.filter(workflow=workflow).first(), is_(none()))
